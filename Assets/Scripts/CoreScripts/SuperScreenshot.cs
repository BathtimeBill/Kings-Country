...
public class SuperScreenshot : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        EditorGUILayout.EndHorizontal();
        EditorGUILayout.BeginHorizontal();
        if (GUILayout.Button("720p")) { CaptureWidth = 1280; CaptureHeight = 720; }
        if (GUILayout.Button("1080p")) { CaptureWidth = 1920; CaptureHeight = 1080; }
        if (GUILayout.Button("2160p")) { CaptureWidth = 3840; CaptureHeight = 2160; }
        if (GUILayout.Button("4320p")) { CaptureWidth = 7680; CaptureHeight = 4320; }
        EditorGUILayout.EndHorizontal();
