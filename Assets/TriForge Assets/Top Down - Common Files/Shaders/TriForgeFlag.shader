	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime7 = _TimeParameters.x * _AnimationSpeed;
				float3 ase_worldPos = TransformObjectToWorld( (v.positionOS).xyz );
				float2 texCoord27 = v.texcoord1.xy * float2( 2,-1.54 ) + ase_worldPos.xy;
				float2 panner18 = ( mulTime7 * float2( -1,0 ) + texCoord27);
				float simplePerlin2D36 = snoise( panner18*( 0.2 * _AnimationScale ) );
				float2 texCoord8 = v.texcoord1.xy * float2( 5,0.2 ) + ase_worldPos.xy;
				float2 panner4 = ( mulTime7 * float2( 0,-1 ) + texCoord8);
				...
				float2 texCoord17 = v.texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 vertexValue = ( ( appendResult31 * _AnimationStrength ) * texCoord17.x ).xyz;
						 ...
						 ) : SV_Target
			{
				...
				float3 BaseColor = ( tex2DNode51 * _Color ).rgb;
				float3 Normal = UnpackNormalScale( tex2D( _Normal, uv_Normal ), 1.0f );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = tex2DNode54.r;
				float Smoothness = tex2DNode54.a;
				float Occlusion = tex2DNode54.g;
				float Alpha = tex2DNode51.a;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float mulTime7 = _TimeParameters.x * _AnimationSpeed;
				float3 ase_worldPos = TransformObjectToWorld( (v.positionOS).xyz );
				float2 texCoord27 = v.ase_texcoord1.xy * float2( 2,-1.54 ) + ase_worldPos.xy;
				float2 panner18 = ( mulTime7 * float2( -1,0 ) + texCoord27);
				float simplePerlin2D36 = snoise( panner18*( 0.2 * _AnimationScale ) );
				float2 texCoord8 = v.ase_texcoord1.xy * float2( 5,0.2 ) + ase_worldPos.xy;
				float2 panner4 = ( mulTime7 * float2( 0,-1 ) + texCoord8);
				float simplePerlin2D50 = snoise( panner4*( 0.2 * _AnimationScale ) );
				float4 appendResult31 = (float4(( simplePerlin2D36 * 4.0 ) , ( simplePerlin2D50 + -5.0 ) , 0.0 , 0.0));
				float2 texCoord17 = v.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
...
Node;AmplifyShaderEditor.RangedFloatNode;63;-3176.34,216.9562;Inherit;False;Property;_AnimationSpeed;Animation Speed;6;0;Create;True;0;0;0;False;0;False;0;4.61;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;7;-2888.762,221.3501;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;61;-2839.523,462.2871;Inherit;False;Property;_AnimationScale;Animation Scale;5;0;Create;True;0;0;0;False;0;False;0;3;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-1115.275,498.9709;Inherit;False;Property;_AnimationStrength;Animation Strength;4;0;Create;True;0;0;0;False;0;False;0;0.2;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;51;-1601.959,-823.4784;Inherit;True;Property;_BaseColor;Base Color;1;0;Create;True;0;0;0;False;0;False;-1;None;e8fcab8d8e3409c439fcebf500601175;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;2;-1525.413,-587.6088;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0.08018869,0.3806623,1,0;0.5471698,0.5471698,0.5471698,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;53;-1605.274,-393.5127;Inherit;True;Property;_Normal;Normal;2;0;Create;True;0;0;0;False;0;False;-1;None;44c70ba0ebf9bbd4e800d205cb0ff403;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-298.7513,188.9676;Inherit;False;Property;_AlphaCutoff;Alpha Cutoff;7;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;54;-1602.602,-186.6748;Inherit;True;Property;_MaskMap;Mask Map;3;0;Create;True;0;0;0;False;0;False;-1;None;9a8e091abe1ea28469f11f21f38c054d;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;70;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;69;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;75;0,80;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;76;0,80;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;67;3;54;1
WireConnection;67;4;54;4
WireConnection;67;5;54;2
WireConnection;67;6;51;4
WireConnection;67;7;74;0
WireConnection;67;8;32;0
ASEEND*/
//CHKSM=C9779873325CA65AA393DC92AB4EEE57973649C5